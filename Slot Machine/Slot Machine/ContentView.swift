...
//  Slot Machine
//
//  Created by Apoorv Verma on 23/09/22.
//
    ...
    var body: some View {
        ZStack{
            ...
            VStack(alignment: .center, spacing: 40){
                ...
                Text(String(5-counter) + " attempts left")
                    .font(.system(size: 25))
                    .fontWeight(.heavy)
            ...
            .alert(item: $showingAlert) { alert -> Alert in
                switch alert{
                case .success:
                    return Alert(title: Text("Yahhh! you won"), message: Text("Born with a charm"), dismissButton: .cancel())
                
                case .failure:
                    return Alert(title: Text("Opppsss!"), message: Text("Better luck next time"), dismissButton: .cancel())
                }
            }
        }
    }
